  ...
  return (
    <div>
      <div className="flex items-center gap-3 border-b border-border bg-muted/30 px-3 py-2 text-[11px] text-muted-foreground">
        <span>
          <span className="text-emerald-400">{summary.passing}</span> passing
        </span>
        <span>
          <span className="text-rose-400">{summary.failing}</span> failing
        </span>
        <span>
          <span className="text-amber-400">{summary.pending}</span> running
        </span>
        {summary.neutral ? (
          <span>
